...
echo "=== Testing FINAL FIXED COA Query ===\n";
...
$stmt->bind_param("sss", $class_code, $course_code, $class_code);
if (!$stmt->execute()) {
...
if ($count == 8) {
    echo "✓ SUCCESS: Correct! Only CO1 assessments (5 Quiz + 3 Classwork)\n";
} else {
    echo "✗ Problem: Expected 8 rows, got $count\n";
}
