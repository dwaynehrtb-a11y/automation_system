...
echo "=== Finding class codes for student 2022-126653 ===\n";

try {
    $query = "SELECT DISTINCT class_code, midterm_percentage, finals_percentage, term_percentage, term_grade FROM grade_term WHERE student_id='2022-126653'";
    ...
    $query2 = "SELECT DISTINCT class_code FROM grade_term WHERE class_code LIKE '%CCPRGG%'";
